...
/**
 * Base class that represents a row from the 'Constituant' table.
 *
 *
 *
 * @package    propel.generator.Propel.om
 */
abstract class BaseConstituant extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ConstituantPeer';
    ...
    /**
     * The value for the originefrconst field.
     * @var        string
     */
    protected $originefrconst;

    /**
     * The value for the origineanconst field.
     * @var        string
     */
    protected $origineanconst;
    ...
    /**
     * Get the [originefrconst] column value.
     *
     * @return string
     */
    public function getOriginefrconst()
    {
        return $this->originefrconst;
    }

    /**
     * Get the [origineanconst] column value.
     *
     * @return string
     */
    public function getOrigineanconst()
    {
        return $this->origineanconst;
    }
     ...
     * @return Constituant The current object (for fluent API support)
     */
    public function setNumconst($v)
    {
        ...
        if ($this->numconst !== $v) {
            $this->numconst = $v;
            $this->modifiedColumns[] = ConstituantPeer::NUMCONST;
        }
    ...
    /**
     * Set the value of [originefrconst] column.
     *
     * @param string $v new value
     * @return Constituant The current object (for fluent API support)
     */
    public function setOriginefrconst($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->originefrconst !== $v) {
            $this->originefrconst = $v;
            $this->modifiedColumns[] = ConstituantPeer::ORIGINEFRCONST;
        }
    ...
    /**
     * Set the value of [origineanconst] column.
     *
     * @param string $v new value
     * @return Constituant The current object (for fluent API support)
     */
    public function setOrigineanconst($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->origineanconst !== $v) {
            $this->origineanconst = $v;
            $this->modifiedColumns[] = ConstituantPeer::ORIGINEANCONST;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->numconst = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->originefrconst = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->origineanconst = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = ConstituantPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Constituant object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ConstituantPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ConstituantQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ConstituantPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ConstituantPeer::NUMCONST;
        if (null !== $this->numconst) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ConstituantPeer::NUMCONST . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ConstituantPeer::NUMCONST)) {
            $modifiedColumns[':p' . $index++]  = '`NUMCONST`';
        }
        if ($this->isColumnModified(ConstituantPeer::ORIGINEFRCONST)) {
            $modifiedColumns[':p' . $index++]  = '`ORIGINEFRCONST`';
        }
        if ($this->isColumnModified(ConstituantPeer::ORIGINEANCONST)) {
            $modifiedColumns[':p' . $index++]  = '`ORIGINEANCONST`';
        }

        $sql = sprintf(
            'INSERT INTO `Constituant` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`NUMCONST`':
                        ...
                        break;
                    case '`ORIGINEFRCONST`':
                        $stmt->bindValue($identifier, $this->originefrconst, PDO::PARAM_STR);
                        break;
                    case '`ORIGINEANCONST`':
                        $stmt->bindValue($identifier, $this->origineanconst, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ConstituantPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ConstituantPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getOriginefrconst();
                break;
            case 2:
                return $this->getOrigineanconst();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Constituant'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Constituant'][$this->getPrimaryKey()] = true;
        $keys = ConstituantPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getNumconst(),
            $keys[1] => $this->getOriginefrconst(),
            $keys[2] => $this->getOrigineanconst(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setOriginefrconst($value);
                break;
            case 2:
                $this->setOrigineanconst($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setNumconst($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setOriginefrconst($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setOrigineanconst($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ConstituantPeer::NUMCONST)) $criteria->add(ConstituantPeer::NUMCONST, $this->numconst);
        if ($this->isColumnModified(ConstituantPeer::ORIGINEFRCONST)) $criteria->add(ConstituantPeer::ORIGINEFRCONST, $this->originefrconst);
        if ($this->isColumnModified(ConstituantPeer::ORIGINEANCONST)) $criteria->add(ConstituantPeer::ORIGINEANCONST, $this->origineanconst);
    ...
    {
        $criteria = new Criteria(ConstituantPeer::DATABASE_NAME);
        $criteria->add(ConstituantPeer::NUMCONST, $this->numconst);
    ...
    /**
     * Generic method to set the primary key (numconst column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of Constituant (or compatible) type.
    ...
    {
        $copyObj->setOriginefrconst($this->getOriginefrconst());
        $copyObj->setOrigineanconst($this->getOrigineanconst());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setNumconst(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Constituant Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ConstituantPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ConstituantPeer();
        }
     ...
     * If this Constituant is new, it will return
    ...
    public function setCompNutris(PropelCollection $compNutris, PropelPDO $con = null)
    {
        ...
        foreach ($this->compNutrisScheduledForDeletion as $compNutriRemoved) {
            $compNutriRemoved->setConstituant(null);
        }
     ...
     * Otherwise if this Constituant is new, it will return
     * an empty collection; or if this Constituant has previously
     * been saved, it will retrieve related CompNutris from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Constituant.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        $this->numconst = null;
        $this->originefrconst = null;
        $this->origineanconst = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(ConstituantPeer::DEFAULT_STRING_FORMAT);
    }

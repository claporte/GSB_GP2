...
/**
 * Base class that represents a row from the 'Aliment' table.
 *
 *
 *
 * @package    propel.generator.Propel.om
 */
abstract class BaseAliment extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'AlimentPeer';
    ...
    /**
     * The value for the nomfraliment field.
     * @var        string
     */
    protected $nomfraliment;

    /**
     * The value for the nomanaliment field.
     * @var        string
     */
    protected $nomanaliment;
    ...
    /**
     * Get the [nomfraliment] column value.
     *
     * @return string
     */
    public function getNomfraliment()
    {
        return $this->nomfraliment;
    }

    /**
     * Get the [nomanaliment] column value.
     *
     * @return string
     */
    public function getNomanaliment()
    {
        return $this->nomanaliment;
    }
     ...
     * @return Aliment The current object (for fluent API support)
     */
    public function setNumaliment($v)
    {
        ...
        if ($this->numaliment !== $v) {
            $this->numaliment = $v;
            $this->modifiedColumns[] = AlimentPeer::NUMALIMENT;
        }
    ...
    /**
     * Set the value of [nomfraliment] column.
     *
     * @param string $v new value
     * @return Aliment The current object (for fluent API support)
     */
    public function setNomfraliment($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->nomfraliment !== $v) {
            $this->nomfraliment = $v;
            $this->modifiedColumns[] = AlimentPeer::NOMFRALIMENT;
        }
    ...
    /**
     * Set the value of [nomanaliment] column.
     *
     * @param string $v new value
     * @return Aliment The current object (for fluent API support)
     */
    public function setNomanaliment($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->nomanaliment !== $v) {
            $this->nomanaliment = $v;
            $this->modifiedColumns[] = AlimentPeer::NOMANALIMENT;
        }
    ...
    public function setNumgenre($v)
    {
        ...
        if ($this->numgenre !== $v) {
            $this->numgenre = $v;
            $this->modifiedColumns[] = AlimentPeer::NUMGENRE;
        }

        if ($this->aGenre !== null && $this->aGenre->getNumgenre() !== $v) {
            $this->aGenre = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->nomfraliment = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->nomanaliment = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->numgenre = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = AlimentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Aliment object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aGenre !== null && $this->numgenre !== $this->aGenre->getNumgenre()) {
            $this->aGenre = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AlimentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AlimentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AlimentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->compNutrisScheduledForDeletion !== null) {
                if (!$this->compNutrisScheduledForDeletion->isEmpty()) {
                    CompNutriQuery::create()
                        ->filterByPrimaryKeys($this->compNutrisScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AlimentPeer::NUMALIMENT)) {
            $modifiedColumns[':p' . $index++]  = '`NUMALIMENT`';
        }
        if ($this->isColumnModified(AlimentPeer::NOMFRALIMENT)) {
            $modifiedColumns[':p' . $index++]  = '`NOMFRALIMENT`';
        }
        if ($this->isColumnModified(AlimentPeer::NOMANALIMENT)) {
            $modifiedColumns[':p' . $index++]  = '`NOMANALIMENT`';
        }
        if ($this->isColumnModified(AlimentPeer::NUMGENRE)) {
            $modifiedColumns[':p' . $index++]  = '`NUMGENRE`';
        }

        $sql = sprintf(
            'INSERT INTO `Aliment` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`NUMALIMENT`':
                        ...
                        break;
                    case '`NOMFRALIMENT`':
                        $stmt->bindValue($identifier, $this->nomfraliment, PDO::PARAM_STR);
                        break;
                    case '`NOMANALIMENT`':
                        $stmt->bindValue($identifier, $this->nomanaliment, PDO::PARAM_STR);
                        break;
                    case '`NUMGENRE`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AlimentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AlimentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getNomfraliment();
                break;
            case 2:
                return $this->getNomanaliment();
                break;
            case 3:
    ...
    {
        if (isset($alreadyDumpedObjects['Aliment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Aliment'][$this->getPrimaryKey()] = true;
        $keys = AlimentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getNumaliment(),
            $keys[1] => $this->getNomfraliment(),
            $keys[2] => $this->getNomanaliment(),
            $keys[3] => $this->getNumgenre(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setNomfraliment($value);
                break;
            case 2:
                $this->setNomanaliment($value);
                break;
            case 3:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setNomfraliment($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setNomanaliment($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setNumgenre($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AlimentPeer::NUMALIMENT)) $criteria->add(AlimentPeer::NUMALIMENT, $this->numaliment);
        if ($this->isColumnModified(AlimentPeer::NOMFRALIMENT)) $criteria->add(AlimentPeer::NOMFRALIMENT, $this->nomfraliment);
        if ($this->isColumnModified(AlimentPeer::NOMANALIMENT)) $criteria->add(AlimentPeer::NOMANALIMENT, $this->nomanaliment);
        if ($this->isColumnModified(AlimentPeer::NUMGENRE)) $criteria->add(AlimentPeer::NUMGENRE, $this->numgenre);
    ...
    {
        $criteria = new Criteria(AlimentPeer::DATABASE_NAME);
        $criteria->add(AlimentPeer::NUMALIMENT, $this->numaliment);
    ...
    /**
     * Generic method to set the primary key (numaliment column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getNumaliment();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Aliment (or compatible) type.
    ...
    {
        $copyObj->setNomfraliment($this->getNomfraliment());
        $copyObj->setNomanaliment($this->getNomanaliment());
        $copyObj->setNumgenre($this->getNumgenre());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setNumaliment(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Aliment Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($v === null) {
            $this->setNumgenre(NULL);
        } else {
            $this->setNumgenre($v->getNumgenre());
        }
    ...
    {
        if ($this->aGenre === null && (($this->numgenre !== "" && $this->numgenre !== null))) {
            $this->aGenre = GenreQuery::create()->findPk($this->numgenre, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGenre->addAliments($this);
             */
        }
     ...
     * If this Aliment is new, it will return
    ...
    public function setCompNutris(PropelCollection $compNutris, PropelPDO $con = null)
    {
        ...
        foreach ($this->compNutrisScheduledForDeletion as $compNutriRemoved) {
            $compNutriRemoved->setAliment(null);
        }
     ...
     * Otherwise if this Aliment is new, it will return
     * an empty collection; or if this Aliment has previously
     * been saved, it will retrieve related CompNutris from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Aliment.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|CompNutri[] List of CompNutri objects
     */
    public function getCompNutrisJoinSource($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CompNutriQuery::create(null, $criteria);
    ...
    public function clear()
    {
        ...
        $this->nomfraliment = null;
        $this->nomanaliment = null;
        $this->numgenre = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(AlimentPeer::DEFAULT_STRING_FORMAT);
    }
